...
export class Hdate {
    ...
    set_jd(jd) {
        ...
        /* let is_leap = (jd_tishrey1_next_year - jd_tishrey1) > 355;
 
         if (is_leap) {
             // Leap year: Adar I (6) becomes 7, Adar II (7) becomes 8, Nisan (8) becomes 9...
             this.hd_mon = (raw_mon >= 6) ? raw_mon + 1 : raw_mon;
         } else {
             // Plain year: Adar (6) stays 6, Nisan (7) becomes 9...
             this.hd_mon = (raw_mon > 6) ? raw_mon + 2 : raw_mon;
         }*/
        this.hd_mon = raw_mon;
    ...
    numToHebrew(num, isYear = false) {
        ...
        const letters = [
            { val: 400, l: "ת" }, { val: 300, l: "ש" }, { val: 200, l: "ר" }, { val: 100, l: "ק" },
            { val: 90, l: "צ" }, { val: 80, l: "פ" }, { val: 70, l: "ע" }, { val: 60, l: "ס" },
            { val: 50, l: "נ" }, { val: 40, l: "מ" }, { val: 30, l: "ל" }, { val: 20, l: "כ" },
            { val: 10, l: "י" }, { val: 9, l: "ט" }, { val: 8, l: "ח" }, { val: 7, l: "ז" },
            { val: 6, l: "ו" }, { val: 5, l: "ה" }, { val: 4, l: "ד" }, { val: 3, l: "ג" },
            { val: 2, l: "ב" }, { val: 1, l: "א" }
        ];

        if (n === 15) return str + "טו";
        if (n === 16) return str + "טז";
